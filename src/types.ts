...
export interface GameState {
  ...
  items: { heal: number; heal2: number; heal3: number; exp_tome: number; evo_dust: number; trait_elixir: number; catch_charm: number; revive: number; evo_incense: number } // 傷薬 / 上傷薬
  money: number // 所持金（ゲル）
